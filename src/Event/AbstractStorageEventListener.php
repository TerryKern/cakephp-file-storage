...
abstract class AbstractStorageEventListener implements EventListenerInterface
{
    ...
    {
        if (!in_array($this->storageTableClass, ['\Burzum\FileStorage\Model\Table\FileStorageTable', '\Burzum\FileStorage\Model\Table\ImageStorageTable'])) {
